          ...
          <div className={"itemContainer2"}>
            ...
            <div className={"content2"}>
              ...
              <div className={"pointsblock"}>
                <p className={"points"}>
                  <span className={"tick1"}>&#10003;</span>{"Bot without the AI service."}
                </p>
              </div>
              <div className={"pointsblock"}>
                <p className={"points"}>
                  <span className={"tick1"}>&#10003;</span>{"Achieved chat for 30 days."}
                </p>
              </div>
              <div className={"pointsblock"}>
                <p className={"points"}>
          ...
          <div className={"itemContainer3"}>
            ...
            <div className={"content3"}>
              ...
              <div className={"pointsblock3"}>
                <p className={"points3"}>
                  <span className={"tick2"}>&#10003;</span>{"Unlimited conversational flows."}
                </p>
              </div>
              <div className={"content2Points"}>
                <div className={"longpara"}>
              ...
              <div className={"pointsblock3"}>
                <p className={"points3"}>
                  <span className={"tick2"}>&#10003;</span>{"Achieved chat without limits."}
                </p>
              </div>
